...
{
    // public class QSYSProtocol : AAVReceiverProtocol
    // {
    //     private SoundUnitedVolumeController _mainVolumeController;
    //     private const double MainZoneVolumeStep = 0.5;
    //     public QSYSProtocol(ISerialTransport transport, byte id) : base(transport, id)
    //     {
    //         
    //         QsysController = new Hardware("192.168.10.214", "username", "password", debug);
    //         
    //     }
    //
    //     private string debug(string arg)
    //     {
    //         CrestronConsole.PrintLine("[QSYS]{0}",arg );
    //         return "";
    //
    //     }
    //
    //     public Hardware QsysController { get; set; }
    //
    ...
    //         CrestronConsole.PrintLine($"Set Volume to {volume - 100}");
    //         QsysController.SendLevel("AVR","*",volume - 100 , 1.5);
    //         //
    ...
    public class SoundUnitedAvrProtocol : AAVReceiverProtocol
    {
        ...
        public override void SetAudioInput(AudioConnections input)
        {
            if (input == AudioConnections.Input1)
            {
            ...
            switch (input)
            {
                ...
                case AudioConnections.Input1:
                    QsysController.SetInput("AVR", 1);
                    break;
               case AudioConnections.Input2:
                   QsysController.SetInput("AVR", 2);
                    break;
                case AudioConnections.Input3:
                    QsysController.SetInput("AVR", 3);
                    break;
                case AudioConnections.Input4:
                    QsysController.SetInput("AVR", 4);
                    break;
                case AudioConnections.Input5:
                    QsysController.SetInput("AVR", 5);
                    break;
                case AudioConnections.Input6:
                    QsysController.SetInput("AVR", 6);
                    break;
                case AudioConnections.Input7:
                    QsysController.SetInput("AVR", 7);
                    break;
                case AudioConnections.Input8:
                    QsysController.SetInput("AVR", 8);
                    break;
                    ...
                    validatedData.CommandGroup == CommonCommandGroupType.AvrZone2)
                {
                    switch (validatedData.CustomCommandGroup)
                    {
                        case SoundUnitedAvrResponseValidation.ZoneVolumeCommandGroup:
                            ...
                            //todo Gather and Update on Mixer Volume Change Responses.!!
